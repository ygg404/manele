<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" @sort-change="changeSort" style="width: 100%;">
      ...
      <el-table-column prop="id" header-align="center" align="center" label="书名Id"></el-table-column>
      <el-table-column prop="sectionName" header-align="center" align="center" label="章名"></el-table-column>
      <el-table-column prop="articleId" header-align="center" align="center" label=""></el-table-column>
      <el-table-column prop="articleName" header-align="center" align="center" label="书名"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/article/content/list'),
          method: 'get',
